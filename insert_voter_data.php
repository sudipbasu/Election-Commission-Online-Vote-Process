...
<form action="insert_voter_data_action.php" name="f1" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="father_husband_name" placeholder="Enter Father's/Husband's Name...." required>
      </div>
      <div class="form-group">
