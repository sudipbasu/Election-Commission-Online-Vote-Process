...
<div class="container">
		...
		{
		    $vote=$_POST['vote'];
		    $sql="select count(*) as total_count from count_vote where VOTE='$vote'";
		    $rs=mysqli_query($con, $sql);
		    $row = mysqli_fetch_object($rs);
		   // echo $row->total_count;
		    ?>
		   <center> <h1>Total Vote For <?php echo $vote;?> is <?php echo $row->total_count;?></h1>
		   </center>
		    <?php
		}
		?>
