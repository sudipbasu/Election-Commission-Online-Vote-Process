...
<div class="container">
    ...
    <form action="vote_online_action.php" name="f1" method="POST">
        <div class="form-group">
            <label for="usr">Voter Card Number:</label>
            <input type="number" class="form-control" name="voter_card_number">
          </div>
          <div class="form-group">
