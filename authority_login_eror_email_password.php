...
<body>
    ...
    <strong>Error!</strong> Contact with Administration for Email ID and Password.
  </div>
<div class="container">
  <h2>Admin Login</h2>
  <form action="authority_login_action.php" method="POST" name="f1">
  ...
  <font style="color: red;">*</font>Please Close this page If you are not an Admin
</div>
<script type="text/javascript">
console.warn("Plz Close this window if you don't know the corect ID and Password");
</script>
</body>
</html>
