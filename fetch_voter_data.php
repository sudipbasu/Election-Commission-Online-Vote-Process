  ...
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        ...
        <th>Voter DOB</th>
        <th>VOTER GENDER</th>
        <th>VOTER FATHER'S/HUSBAND NAME</th>
        <th>VOTER ADDRESS</th>
        <th>VOTER POSTAL CODE</th>
        <th>VOTER IMAGE</th>
    ...
    <tbody id="myTable">
    <?php 
    $conn = mysqli_connect("localhost","root","","online vote process");
    $sql = "select * from voter_data";
    ...
    ?>
      <tr>
        ...
        <td><img alt="Update your Browser" src="Image_Folder/<?php echo $data[7];?>" height="100px"></td>
